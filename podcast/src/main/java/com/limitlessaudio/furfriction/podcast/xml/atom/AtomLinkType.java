...
public class AtomLinkType {
    ...
    /**
     * The element may contain a rel attribute, which contains a keyword that identifies the nature of the relationship between the linked resouce and the element.
     * Five relationships are possible:<br>
     * <br>self:<br>
     ...
     * <br>
     * The method returns the rel attributes as {@link String} object.
     * @return the rel
     */
